            ...
            for filename in files:
                ...
                try:
                    ...
                    if asset_type == "models":
                        ...
                        # example path, png dir is the path where the png files are moved to after extraction, maintaining the same structure as the txd dir after the 'quickbms_out\'
